...
namespace Strizhi.TelegramPart.logics
{
    public class TextCleaner()
    {
        public static async Task<string> CleanText(string text)
        {
            ...
            List<string> DeliteFlags = new List<string>{"Телефон:", "СНИЛС:", "ИНН:", "Email:",
                                                        "Автомобили:", "Паспорт:", "Документ:",
                                                        "Дата выдачи паспорта:", "Код подразделения:",
                                                        "Код КЛАДР:","Связанные телефоны:", "Ссылка:",
                                                        "ID", "id", "Кем выдан паспорт:",
                                                        "Дата выдачи водительского удостоверения:",
                                                        "Хеш пользователя", "ОГРН ИП:", "ОКВЭД:",
                                                        "ОГРН юр. лица:","Фотография:", "Домен VK:",
                                                        "link:", "Полис ОМС:", "IP-адрес",
                                                        "Маскированный номер карты:", "Номер заказа:",
                                                         "Дата вылета:", "Логин:", "Пункт выдачи:" 
            };
